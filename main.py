...
class FasterRCNN():
    # ІніціалізуЄ модель Faster R-CNN конфігураціями та ідентифікатором GPU.
    ...
    # Навчає модель Faster R-CNN, використовуючи навчальний та тестовий завантажувачі даних.    
    def train(self, train_loader, test_loader):
        ...
        for epoch in range(self.TRAIN_config['epochs']):
            ...
            print()
    # Перевірка моделі Faster R-CNN за допомогою завантажувача тестових даних            
    def val(self, test_loader):
        ...
        return mAP
    # Запустіть модель FasterRCNN на одному зображенні для демонстрації.
    def demo(self, image_dir):
        self.model.eval()
        with torch.no_grad():
            # Завантажуємо та попередньо обробляємо зображення
